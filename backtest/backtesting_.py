...
# GOOG["signal"] = ctx["signal_df"]["signal"]

signal_df = ctx["signal_df"]
stonk_df = ctx["stonk_df"]
stonk_df["signal"] = signal_df["signal"]
print(f"signal_df['signal']:\n{signal_df['signal']} {type(signal_df['signal'])}")
print(f"stonk_df['signal']:\n{stonk_df['signal']} {type(stonk_df['signal'])}")
